...
// ICI : Tu devras ajouter une vérification pour être sûr que c'est un ADMIN
...
<body class="bg-light font-sans antialiased flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-dark text-white flex flex-col shadow-2xl z-20">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            <a href="#" class="flex items-center gap-3 px-4 py-3 bg-primary/10 text-primary rounded-xl transition font-medium">
                <i class="fa-solid fa-chart-pie w-5"></i>
                Vue d'ensemble
            </a>

            <a href="#" class="flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 rounded-xl transition font-medium">
        ...
        <div class="p-4 border-t border-gray-800">
            <a href="logout.php" class="flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-500/10 rounded-xl transition font-medium">
                        ...
                        <tbody class="text-sm divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="p-4 text-right space-x-2">
                                    <button class="text-green-600 hover:bg-green-50 p-2 rounded transition" title="Valider"><i class="fa-solid fa-check"></i></button>
                                    <button class="text-red-500 hover:bg-red-50 p-2 rounded transition" title="Refuser"><i class="fa-solid fa-xmark"></i></button>
                                </td>
                            </tr>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="p-4">
                                    <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold">Confirmée</span>
                                </td>
                                <td class="p-4 text-right space-x-2">
                                    <button class="text-gray-400 hover:bg-gray-100 p-2 rounded transition"><i class="fa-solid fa-ellipsis-vertical"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
